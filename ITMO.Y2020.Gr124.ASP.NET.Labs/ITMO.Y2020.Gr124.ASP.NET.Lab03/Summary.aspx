<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Summary.aspx.cs" Inherits="ITMO.Y2020.Gr124.ASP.NET.Lab03.Summary" %>
...
<body>
    ...
    <table> 
        ...
        <tbody> 
            ...
            <% var yesData = ITMO.Y2020.Gr124.ASP.NET.Lab03.ResponseRepository.GetRepository().GetAllResponses()
