<%@ Page MasterPageFile="~/Site.Master" Language="C#" AutoEventWireup="true" CodeBehind="Start.aspx.cs" Inherits="ITMO.Y2020.Gr124.ASP.NET.Lab06.Start" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"> 
    <div> 
        <div class="rek"> 
            ...
            <p class="debugtext">(from start.aspx lab06)</p>
